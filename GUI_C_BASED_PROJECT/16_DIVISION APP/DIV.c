...
{
    static TCHAR szAppName[] = TEXT("DIVISION APP");
    HWND hwnd;
    MSG msg;
    WNDCLASS wndclass;
    ...
    hwnd = CreateWindow(szAppName, TEXT("DIVISION APP"),
                        WS_OVERLAPPEDWINDOW,
...
{
    static HWND hwndNum1, hwndNum2, hwndResultText, hwndButtonDivide;
    PAINTSTRUCT ps;
    HDC hdc;
    RECT rect;
    switch (message)
    ...
    case WM_CREATE:
        ...
        hwndButtonDivide = CreateWindow(TEXT("BUTTON"), TEXT("Divide"),
    ...
    case WM_COMMAND:
        if (LOWORD(wParam) == 1 && HIWORD(wParam) == BN_CLICKED) {
            // Perform division when the button is clicked
            ...
            if (num2 != 0) { // Check for division by zero
                ...
                SetWindowText(hwndResultText, TEXT("Division by zero error"));
            }
        }
        return 0;
