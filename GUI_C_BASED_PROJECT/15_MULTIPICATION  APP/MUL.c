...
{
    static TCHAR szAppName[] = TEXT("MULTIPLICATION APP");
    HWND hwnd;
    MSG msg;
    WNDCLASS wndclass;
    ...
    hwnd = CreateWindow(szAppName, TEXT("MULTIPLICATION APP"),
                        WS_OVERLAPPEDWINDOW,
...
{
    static HWND hwndNum1, hwndNum2, hwndResultText, hwndButtonMultiply;
    PAINTSTRUCT ps;
    HDC hdc;
    RECT rect;
    switch (message)
    ...
    case WM_CREATE:
        ...
        hwndButtonMultiply = CreateWindow(TEXT("BUTTON"), TEXT("Multiply"),
    ...
    case WM_COMMAND:
        if (LOWORD(wParam) == 1 && HIWORD(wParam) == BN_CLICKED) {
            // Perform multiplication when the button is clicked
