...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    // Create the window
    hWndMain = CreateWindow(TEXT("WindowApp"), TEXT("Heptagon Shape"), WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_PAINT:
    {
        ...
        COLORREF colorStart = RGB(255, 255, 0); // Yellow
        COLORREF colorEnd = RGB(255, 165, 0); // Orange
        ...
        POINT heptagon[7] = {
            ...
            { gradientRect.right / 2 - 100, gradientRect.bottom / 2 + 50 }, // Left
