...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_PAINT:
    {
        ...
        // Draw an ellipse shape in the center
        int centerX = gradientRect.right / 2;
        int centerY = gradientRect.bottom / 2;
        int width = 200; // Change this value to adjust the width of the ellipse
        int height = 100; // Change this value to adjust the height of the ellipse
