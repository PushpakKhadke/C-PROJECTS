...
{
    static TCHAR szAppName[] = TEXT("ADDITION APP");
    HWND hwnd;
    MSG msg;
    WNDCLASS wndclass;
    ...
    hwnd = CreateWindow(szAppName, TEXT("ADDITION APP"),
                        WS_OVERLAPPEDWINDOW,
...
{
    static HWND hwndNum1, hwndNum2, hwndResultText, hwndButtonAdd;
    PAINTSTRUCT ps;
    HDC hdc;
    RECT rect;
    switch (message)
    ...
    case WM_CREATE:
        ...
        hwndButtonAdd = CreateWindow(TEXT("BUTTON"), TEXT("Add"),
